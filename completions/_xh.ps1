...
Register-ArgumentCompleter -Native -CommandName 'xh' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'xh' {
            ...
            [CompletionResult]::new('--path-as-is', '--path-as-is', [CompletionResultType]::ParameterName, 'Bypass dot segment (/../ or /./) URL squashing')
            ...
            [CompletionResult]::new('--no-path-as-is', '--no-path-as-is', [CompletionResultType]::ParameterName, 'no-path-as-is')
