...
Register-ArgumentCompleter -Native -CommandName 'xh' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'xh' {
            ...
            [CompletionResult]::new('--http2', 'http2', [CompletionResultType]::ParameterName, 'Force to use HTTP/2')
            ...
            [CompletionResult]::new('--no-http2', 'no-http2', [CompletionResultType]::ParameterName, 'no-http2')
