...
Register-ArgumentCompleter -Native -CommandName 'xh' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'xh' {
            ...
            [CompletionResult]::new('--httpsig-keyid', '--httpsig-keyid', [CompletionResultType]::ParameterName, 'Message signature key identifier (RFC 9421)')
            [CompletionResult]::new('--httpsig-key', '--httpsig-key', [CompletionResultType]::ParameterName, 'Message signature key or key file (RFC 9421)')
            [CompletionResult]::new('--httpsig-algo', '--httpsig-algo', [CompletionResultType]::ParameterName, 'Message signature algorithm (RFC 9421)')
            [CompletionResult]::new('--httpsig-headers', '--httpsig-headers', [CompletionResultType]::ParameterName, 'Space-separated list of message signature components (RFC 9421)')
            ...
            [CompletionResult]::new('--no-httpsig-keyid', '--no-httpsig-keyid', [CompletionResultType]::ParameterName, 'no-httpsig-keyid')
            [CompletionResult]::new('--no-httpsig-key', '--no-httpsig-key', [CompletionResultType]::ParameterName, 'no-httpsig-key')
            [CompletionResult]::new('--no-httpsig-algo', '--no-httpsig-algo', [CompletionResultType]::ParameterName, 'no-httpsig-algo')
            [CompletionResult]::new('--no-httpsig-headers', '--no-httpsig-headers', [CompletionResultType]::ParameterName, 'no-httpsig-headers')
