...
set edit:completion:arg-completer[xh] = {|@words|
    ...
    var completions = [
        &'xh'= {
            ...
            cand --unstable-m-sig-id 'Message signature key identifier (RFC 9421)'
            cand --unstable-m-sig-key 'Message signature key material (RFC 9421)'
            cand --unstable-m-sig-alg 'Message signature algorithm (RFC 9421)'
            cand --unstable-m-sig-comp 'Comma-separated list of message signature components (RFC 9421)'
            ...
            cand --no-unstable-m-sig-id 'no-unstable-m-sig-id'
            cand --no-unstable-m-sig-key 'no-unstable-m-sig-key'
            cand --no-unstable-m-sig-alg 'no-unstable-m-sig-alg'
            cand --no-unstable-m-sig-comp 'no-unstable-m-sig-comp'
