...
set edit:completion:arg-completer[xh] = {|@words|
    ...
    var completions = [
        &'xh'= {
            ...
            cand --httpsig-keyid 'Message signature key identifier (RFC 9421)'
            cand --httpsig-key 'Message signature key or key file (RFC 9421)'
            cand --httpsig-algo 'Message signature algorithm (RFC 9421)'
            cand --httpsig-headers 'Space-separated list of message signature components (RFC 9421)'
            ...
            cand --no-httpsig-keyid 'no-httpsig-keyid'
            cand --no-httpsig-key 'no-httpsig-key'
            cand --no-httpsig-algo 'no-httpsig-algo'
            cand --no-httpsig-headers 'no-httpsig-headers'
